...
case class StorageConfig(`type`: String, storageKey: String, storageSecret: String, endPoint: Option[String] = None, region: Option[String] = Option(""), authType: Option[String] = Option("access_key"))

object StorageServiceFactory {

  private def isIAMAuth(authType: Option[String]): Boolean = {
